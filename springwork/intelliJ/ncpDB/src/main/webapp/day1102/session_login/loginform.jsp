...
<%
    ...
    String savesstatus = (String)session.getAttribute("savestatus");
    boolean bCheck;
    if(savesstatus == null || savesstatus.equals("no")){ // 널 조건을 반드시 먼저 써야함.
...
<div style="margin:30px 100px;">
    <form action="loginaction.jsp" method="post">
        <table class="table table-bordered" style="width:300px;border:5px groove gray;">
            <caption align="top">
                <label><input type="checkbox" name="saveid" <%=bCheck? "checked": ""%>>아이디저장</label>
            </caption>
            <tr>
                <td width=150>
